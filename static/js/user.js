$(window).load(function() {
    ...
    $('#checkdates_teacher').on('apply.daterangepicker', function(ev, picker) {
        var startDate = toTimeStamp(picker.startDate.format('MM/DD/YYYY'));
        var endDate = toTimeStamp(picker.endDate.format('MM/DD/YYYY'));
        var url = '/admin/teachers/api/detail/' + id
        var recordsTe = {}
        $.ajax({
            url: url,
            type: 'GET',
